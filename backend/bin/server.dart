...
Future<void> main() async {
  ...
  // Determine correct assets path based on CWD
  String assetBasePath = 'assets/images/clothes';
  if (!Directory('assets').existsSync() && Directory('../assets').existsSync()) {
    assetBasePath = '../assets/images/clothes';
    print('Using assets path: $assetBasePath');
  } else {
    print('Using assets path: $assetBasePath');
  }
  ...
  await for (HttpRequest request in server) {
    try {
      ...
      if (request.method == 'POST' && request.uri.path == '/signup') {
        ...
        final filePath = '$assetBasePath/$filename';
        ...
        try {
          ...
          await for (final part in stream) {
            ...
            if (partName == 'image') {
              ...
              final filePath = '$assetBasePath/$savedFilename';
              final file = File(filePath);
